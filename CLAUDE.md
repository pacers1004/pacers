...
### Context 90% 근처에서 자동으로 실행

**목표**: 문서 동기화는 자동화하되, 대표님이 항상 최종 승인권 유지

**Step 1: 변경사항 정리**
- CHANGELOG.md에 오늘 작업 내용 추가
- CLAUDE.md 필요 시 업데이트

**Step 2: 대표님에게 물어보기**
```
"작업 완료했어요. 다음 내용을 GitHub에 push 할까요?
...
**Step 4: Push 완료**
- `git add -A && git commit -m "..." && git push` 실행
- GitHub에 자동 반영
- 다음 Claude Code 세션부터 모든 변경사항 반영됨
...
- Context 90% 근처에서 자동으로 대표님에게 물어봄
